...
<!-- content -->
                                                ...
                                                <div class="wrapper">
                                                    ...
                                                    <article class="grid_8 omega">
                                                        <div class="indent-right">
                                                            <h3 class="p2"> Select event to add its Beverages!</h3>
 ...
 include "nrsk_event_db_connection.php";
		$sql = "INSERT INTO beverage_packages SET bev_packg_name='$_SESSION[pack_name]' ,main_event_id='$_SESSION[event_name_id]'"; 
	...
	if($rs == 1)
	{
		...
		$sql1="Select * FROM beverage_packages where bev_packg_name='$_SESSION[pack_name]' AND main_event_id=$_SESSION[event_name_id]";
			...
			while($row = mysql_fetch_array($rs))
	{
		...
		header('Location:add_bev_page.php');
...
<footer>
  ...
  <div class="wrapper">
                	<div class="grid_4">
                    	<div>Registerd Web &copy; 2018 <a class="link color-3" href="#">Privacy Policy</a></div>
