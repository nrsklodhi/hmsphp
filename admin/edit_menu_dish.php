...
<!-- content -->
  ...
  <tr>
                                                ...
                                                <div class="wrapper">
                                                    ...
                                                    <article class="grid_8 omega">
                                                        <div class="indent-right">
                                                            <h3 class="p2"> Select Dish to Edit or Delete!</h3>
                                                                 <div class="wrapper prev-indent-bot2">
                                                                 <table width="500">
                                                                 <tr><td width="250"><b>Dish Name</b></td>
                                                                 <td width="100"><b>Price</b></td>
                                                                  <td width="150"><b>Action</b></td></tr>
	...
	if($rs == 1)
	{
	header('Location:edit_menu_dish.php');	
	}
	...
	<td>Rs. &nbsp;".$row['menu_dtl_price']."</td>";
	  echo "<td><a href=edit_dish_page.php?editid=" . $row['menu_detail_id'] . "><b>Edit<b></a> &nbsp;| &nbsp;<a href=edit_menu_dish.php?delid=" . $row['menu_detail_id'] . "><b>Delete <b></a></td></tr>";
