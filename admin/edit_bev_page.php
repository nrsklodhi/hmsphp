...
<!-- content -->
  ...
  <th width=200 height=40 scope=row >Event Name</th>
    ...
    <th width=228 scope=row align=left>Package Rate</th>
	 <th width=228 scope=row align=left>Action</th>
  </tr>";	
  ...
  <th height=30 scope=row valign=top>".$row['main_event_name']."</th>
	...
	<td><a href=edit_bev_if.php?editid=" . $row['bev_packg_id'] . "><b>EDIT<b></a> &nbsp; | &nbsp; <a href=edit_bev_page.php?delid=" . $row['bev_packg_id'] . "><b>DELETE<b></a></td>";
