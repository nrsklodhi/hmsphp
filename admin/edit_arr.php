...
<!-- content -->
  ...
  <tr>
    ...
    <tr><td colspan="6"><br></td></tr>
                                            ...
                                            <div class="grid_12">
                                                <div class="wrapper">
                                                            ...
                                                            <h3 class="p2"> &nbsp; &nbsp; Arrangement Packages are :</h3>
                                                           
                                                                
                                                                <?php
				include "nrsk_event_db_connection.php";
				$sql="Select * From arrangement_package a, events_table t WHERE a.main_event_id= $_SESSION[event_name_id] AND a.main_event_id=t.main_event_id ";	
	...
	{	
	echo
	 "<table width=900 border=0 cellspacing=2 cellpadding=10 align=center>
  <tr> <th width=200 height=40 scope=row >Event Type</th>
    <th width=240 height=40 scope=row >Package Name</th>
    <th width=180 scope=row align=left>&nbsp; &nbsp; &nbsp; Arrangement Items</th>
  ...
  <tr>
	...
	<td><a href=edit_arr_page.php?editid=" . $row['arr_packg_id'] . "><b>EDIT<b></a> &nbsp; | &nbsp; <a href=checkarr.php?delid=" . $row['arr_packg_id'] . "><b>DELETE<b></a></td>";
	echo "</tr>";
	...
	echo " <tr><td></td> <td bgcolor=#FFCC99 colspan=4> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;   
  </td>
  </tr>";
	}
