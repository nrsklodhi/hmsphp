  ...
  
{
  ...
  echo $arrid[$x];
    include "nrsk_event_db_connection.php";
	$sql = "INSERT INTO menu_packg_details SET menu_packg_id='$_SESSION[menu_packg_id]' ,menu_detail_id='$arrid[$x]'"; 
...
include "nrsk_event_db_connection.php";
		$sql = "UPDATE menu_table SET menu_price='$_SESSION[hr_rate]' ,menu_package_items='$_SESSION[myitems]' WHERE menu_packg_id=$_SESSION[menu_packg_id]"; 
	...
	if($rs == 1)
	{
	header('Location:view_menu_page.php');
	}
