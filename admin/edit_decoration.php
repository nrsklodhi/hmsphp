...
<!-- content -->
  ...
  if(isset($_REQUEST['img_submit3_x']))
	...
	$sql = "UPDATE decoration_details SET dec_type_name='$_REQUEST[pname]' , event_dec_id=$_REQUEST[event_name], dec_price='$_REQUEST[price]' WHERE dec_id=$editid"; 
	...
	header('Location:edit_decorations.php');
  ...
  ?>
	...
	mysql_close($con);
	  ...
	  echo "</select>"; 
               ...
               <tr><td height="40"><span class="text-form"> <strong>  Type Name :</strong></span></td><td><input type="text" name="pname" size="38" value="<?php echo $name ?>"></td></tr>
               <tr><td height="40"><span class="text-form"> <strong>   Price :</strong></span></td><td><input type="text" name="price" size="38"  value="<?php echo $price ?>"></td></tr>
