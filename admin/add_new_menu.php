...
<!-- content -->
  ...
  if(isset($_REQUEST['img_submit3_x']))
	...
	$sql = "INSERT INTO menu_details SET package_item='$_REQUEST[pname]', menu_dtl_price='$_REQUEST[price]'"; 
  ...
  ?>
               ...
               <tr><td height="40"><span class="text-form"> <strong>  Dish Name :</strong></span></td><td><input type="text" name="pname" size="38" ></td></tr>
               <tr><td height="40"><span class="text-form"> <strong>  Dish Price :</strong></span></td><td><input type="text" name="price" size="38"></td></tr>
