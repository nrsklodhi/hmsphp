...
<!-- content -->
  ...
  <tr>
    ...
    <tr><td colspan="6"><br></td></tr>
                                                ...
                                                <div class="wrapper">
                                                    ...
                                                    <article class="grid_8 omega">
                                                        <div class="indent-right">
                                                            <h3 class="p2">Add Decoration Package!</h3>
               ...
               <tr><td height="30"><span class="text-form"> <strong>  Package Name :</strong></span></td><td><input type="text" name="pname" size="38"></td></tr>
               <tr><td height="30" colspan="2"><b>Choose decorations you want in package!</b></td></tr>
  <?php
...
?>
  ...
  <tr><td><br></td></tr>
     ...
     <input type="image"  src="images/button (2).png" name="img_submit5">
	  ...
	  $_SESSION['pack_name']=$_REQUEST['pname'];
        include "nrsk_event_db_connection.php";
		$sql = "INSERT INTO decoration_packages SET dec_packg_name='$_SESSION[pack_name]'"; 
	   ...
	   if($rs == 1)
	   {
		...
		$sql1="Select dec_packg_id FROM decoration_packages ";
    	$rs = mysql_query($sql1) or die(mysql_error());
		if(mysql_num_rows($rs)>0)
		{
  ...
  echo $arrid[$x];
    include "nrsk_event_db_connection.php";
	$sql = "INSERT INTO decoration_pckg_details SET dec_packg_id='$_SESSION[dec_packg_id]' ,dec_id='$arrid[$x]'"; 
...
foreach($my as $value){
 ...
 $_SESSION['hr_rate']=$add;
       ...
       include "nrsk_event_db_connection.php";
		$sql = "UPDATE decoration_packages SET dec_packg_price='$_SESSION[hr_rate]' ,dec_packg_items='$_SESSION[myitems]' WHERE dec_packg_id=$_SESSION[dec_packg_id]"; 
	...
	if($rs == 1)
	{
	header('Location:view_decorations.php');
	}
