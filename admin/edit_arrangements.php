  ...
  <tr>
                                                    ...
                                                    <article class="grid_8 omega">
                                                        <div class="indent-right">
                                                            ...
                                                            <div class="wrapper prev-indent-bot2">
                                                              <table width="600"><tr><td bgcolor="#CCCCCC"><b>Arrangement Name<br></b></td><td bgcolor="#CCCCCC"><b>Arrangement Price<b><br></td><td bgcolor="#CCCCCC"><b>Action<b><br></td></tr>  
		...
		if(mysql_num_rows($rs)>0)
	{
		...
		while($row = mysql_fetch_array($rs))
		{
         ...
         echo "<td>".$row['material_price']."</td>";
         echo "<td><a href=del_arr.php?editid=" . $row['arrangement_id'] . "><b>EDIT<b></a> &nbsp; | &nbsp; <a href=del_arr.php?delid=" . $row['arrangement_id'] . "><b>DELETE<b></a></td></tr>";
	}
