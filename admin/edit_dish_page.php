...
<!-- content -->
                                                ...
                                                <div class="wrapper">
                                                    ...
                                                    <article class="grid_8 omega">
                                                        <div class="indent-right">
                                                            <h3 class="p2"> Enter Data to add New Dish!</h3>
  ...
  if(isset($_REQUEST['img_submit3_x']))
	...
	$sql = "UPDATE menu_details SET package_item='$_REQUEST[pname]', menu_dtl_price='$_REQUEST[price]' WHERE menu_detail_id=$editid"; 
	...
	header('Location:view_menu_dt.php');
  ...
  ?>
               ...
               <tr><td height="40"><span class="text-form"> <strong>  Dish Name :</strong></span></td><td><input type="text" name="pname" size="38"  value="<?php echo $p?>"></td></tr>
               <tr><td height="40"><span class="text-form"> <strong>  Dish Price :</strong></span></td><td><input type="text" name="price" size="38"   value="<?php echo $r?>" ></td></tr>
