...
<!-- content -->
  ...
  <tr>";
   ...
   echo "<td><a href=details.php?myid=" . $row['u_id'] . "><b>View  Details<b></a> &nbsp;| &nbsp;<a href=checkdeco.php?delid=" . $row['order_id'] . "><b>Delete Order<b></a></td></tr>";
