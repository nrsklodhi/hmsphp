...
<!-- content -->
                                                ...
                                                <div class="wrapper">
                                                    ...
                                                    <article class="grid_8 omega">
                                                        <div class="indent-right">
                                                            <h3 class="p2">Enter data in all fields to add new Arrangement!</h3>
	...
	{ 
	 ...
	 $_price=$_REQUEST['price'];
	  include "nrsk_event_db_connection.php";
		$sql = "INSERT INTO event_arrangements SET material_name='$_name' , material_price='$_price'"; 
  ...
  ?>
                                                              ...
                                                              <fieldset>
                                                               <tr><td height="35"><span class="text-form"> <strong>  Enter the Arrangement Name :</strong></span> </td><td><input name="name" type="text" size="38"></td></tr>
                                                               <tr><td height="35"><span class="text-form"> <strong>  Enter the Arrangement Price :</strong></span></td><td><input name="price" type="text" size="38"></td></tr>
